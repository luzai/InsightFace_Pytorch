...
MODEL_P='/home/zl/prj/InsightFace_Pytorch/work_space/emore.r100.bs.ft.tri.dop/save/,0'
USE_TORCH=1
MODEL_P='/home/zl/prj/models/MS1MV2-ResNet100-Arcface/MS1MV2-ResNet100-Arcface,0' 
...
python embeddings_dis.py 

source activate py36
CUDA_VISIBLE_DEVICES="0,1" python tf_test_with_log_mgpu.py "$MODEL_NAME"
