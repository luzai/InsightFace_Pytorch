...
class NASNetAMobile(nn.Module):
    ...
    def __init__(self, num_classes=1001, stem_filters=32, penultimate_filters=1056, filters_multiplier=2):
        ...
        #     nn.Dropout(gl_conf.drop_ratio),
        #     Flatten(),
        #     nn.Linear(24 * filters * 7 * 7, 512),
        #     nn.BatchNorm1d(512)
        # )
        #  way 2 try linear block
        self.output_layer = nn.Sequential(
            Linear_block(24 * filters, 24 * filters, groups=24 * filters, kernel=(7, 7), stride=(1, 1), padding=(0, 0)),
            Flatten(),
