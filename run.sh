...
for wmdm in 1.0,2.25 1.5,1.0 1.0,1.0 1.1,1.86 1.2,1.56 1.3,1.33 1.4,1.15
do
    IFS=","; set -- $wmdm;
    wm=$1; dm=$2; echo $wm and $dm
    python train.py --mbfc_wm $wm --mbfc_dm $dm --work_path work_space/mbfc.$wm.$dm.retina.arc
done
